 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Tianyu Nan");
		  toPrint += p1.toString("tnan3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Yi Xie");
		  toPrint += p2.toString("yxie99");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("cheng zeng");
		  toPrint += p3.toString("czeng38");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Xian Li");
                  toPrint += p4.toString("xli684");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Xibei Zhang");
                  toPrint += p5.toString("xzhang774");
